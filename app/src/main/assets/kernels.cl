...
uchar4 convertYUVtoRGBA(int y, int u, int v) {
    uchar4 ret;
    y -= 16;
    u -= 128;
    v -= 128;
...
__kernel void nv21torgba(__global uchar4
...
__kernel void laplacian(__global uchar4
...
if (lx < LPADDING) {
LOAD_TO_LOCALMEM(gx2 - LHALO, gy - LHALO, lx2, ly); }
if (ly < LPADDING) {
LOAD_TO_LOCALMEM(gx - LHALO, gy2 - LHALO, lx, ly2); }
